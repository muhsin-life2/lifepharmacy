...
const ProductsPageData = ({ data }: { data: any }) => {

    const skeletonArray = Array(12).fill(<ProductsSkeleton />)

    return (
        <div className='py-5 max-w-[1450px]  mx-auto'>
            <nav className="flex px-5 py-3 mb-5 text-gray-700   rounded-lg bg-gray-50 " aria-label="Breadcrumb">
            ...
            <div className='grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-3 min-[300px]:grid-cols-2 grid-cols-1  sm:gap-3 gap-1'>
                {data.length > 1 ? data.map((pro_data: any) => (
